...
Route::get('/orderReminders/{data}', 'HomeController@orderReminder');
...
Route::get('/addReminderPage/{data}', 'HomeController@addReminderPage');

Route::get('/reminderChangePageName/{data}', 'HomeController@changePageName');
...
Route::post('/Admin/Projects/editProject', 'AdminController@editProject');
