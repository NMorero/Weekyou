<template>
    <div>
        <button v-if="user[0] == 'admin'" id="btnOpenAddProjetc" @click="addProjectModal = true">+ Project</button>


        <div id="boxDeleteProjectModal" v-if="deleteProjectModal" @click="handleClickModaldeleteProject">
            <div id="deleteProject">
                <span>Eliminar projecto {{deleteProjectModalTitle}}</span>
                <button id="btnCancelDeleteProject" @click="deleteProjectModal = false">Cancel</button>
                <button id="btnDeleteProject" @click="deleteProject()">Delete</button>
            </div>
        </div>
        ...
        <div id="box1" class="boxProject">
            ...
            <draggable class="list-group" :list="list1" group="people" @change="log1" :disabled="!enabled">
                <div class="list-group-item" v-for="(element, index) in list1" :key="index+'list1'">
                    ...
                    <i  v-if="user[0] == 'admin'" class="iconDots fas fa-ellipsis-h" @click="openConfigProjectTab(element.id)"></i>
                    <div class="divDotsProject" :id="'box1TabContent' + element.id">
                        <button  class="btnDivDotsProject btnDeleteDivDotsProject"  @click="openModalDeleteProject(element.id, 1)">Delete</button>
                        <button  class="btnDivDotsProject btnDeleteDivDotsProject"  @click="storeProject(element.id, 1)">Store</button>
                        <button  class="btnDivDotsProject" @click="closeConfigProjectTab(element.id)">Close</button>
                    </div>
        ...
        <div id="box2" class="boxProject">
            ...
            <draggable class="list-group" :list="list2" group="people" @change="log2" :disabled="!enabled">
                <div class="list-group-item" v-for="(element, index) in list2" :key="index+'list2'">
                    ...
                    <i  v-if="user[0] == 'admin'" class="iconDots fas fa-ellipsis-h" @click="openConfigProjectTab(element.id)"></i>
                    <div class="divDotsProject" :id="'box1TabContent' + element.id">
                        <button  class="btnDivDotsProject btnDeleteDivDotsProject"  @click="openModalDeleteProject(element.id, 2)">Delete</button>
                        <button  class="btnDivDotsProject btnDeleteDivDotsProject"  @click="storeProject(element.id, 2)">Store</button>
                        <button  class="btnDivDotsProject" @click="closeConfigProjectTab(element.id)">Close</button>
                    </div>
                    <span class="projectText">{{element.alias}}</span>
                    <div class="boxInfoProjects" @click="handleClickProject(element.id)">
        ...
        <div id="box3" class="boxProject">
            ...
            <draggable class="list-group" :list="list3" group="people" @change="log3" :disabled="!enabled">
                <div class="list-group-item" v-for="(element, index) in list3" :key="index+'list3'">
                    ...
                    <i  v-if="user[0] == 'admin'" class="iconDots fas fa-ellipsis-h" @click="openConfigProjectTab(element.id)"></i>
                    <div class="divDotsProject" :id="'box1TabContent' + element.id">
                        <button  class="btnDivDotsProject btnDeleteDivDotsProject"  @click="openModalDeleteProject(element.id, 3)">Delete</button>
                        <button  class="btnDivDotsProject btnDeleteDivDotsProject"  @click="storeProject(element.id, 3)">Store</button>
                        <button  class="btnDivDotsProject" @click="closeConfigProjectTab(element.id)">Close</button>
                    </div>
                    <span class="projectText">{{element.alias}}</span>
                    <div class="boxInfoProjects" @click="handleClickProject(element.id)">
        ...
        <div id="box4" class="boxProject">
            ...
            <draggable class="list-group" :list="list4" group="people" @change="log4" :disabled="!enabled">
                <div class="list-group-item" v-for="(element, index) in list4" :key="index+'list4'">
                    ...
                    <i  v-if="user[0] == 'admin'" class="iconDots fas fa-ellipsis-h" @click="openConfigProjectTab(element.id)"></i>
                    <div class="divDotsProject" :id="'box1TabContent' + element.id">
                        <button  class="btnDivDotsProject btnDeleteDivDotsProject"  @click="openModalDeleteProject(element.id, 4)">Delete</button>
                        <button  class="btnDivDotsProject btnDeleteDivDotsProject"  @click="storeProject(element.id, 4)">Store</button>
                        <button  class="btnDivDotsProject" @click="closeConfigProjectTab(element.id)">Close</button>
                    </div>
                    <span class="projectText">{{element.alias}}</span>
                    <div class="boxInfoProjects" @click="handleClickProject(element.id)">
        ...
        <div id="box5" class="boxProject">
            ...
            <draggable class="list-group" :list="list5" group="people" @change="log5" :disabled="!enabled">
                <div class="list-group-item" v-for="(element, index) in list5" :key="index+'list5'">
                    ...
                    <i  v-if="user[0] == 'admin'" class="iconDots fas fa-ellipsis-h" @click="openConfigProjectTab(element.id)"></i>
                    <div class="divDotsProject" :id="'box1TabContent' + element.id">
                        <button  class="btnDivDotsProject btnDeleteDivDotsProject"  @click="openModalDeleteProject(element.id, 5)">Delete</button>
                        <button  class="btnDivDotsProject btnDeleteDivDotsProject"  @click="storeProject(element.id, 5)">Store</button>
                        <button  class="btnDivDotsProject" @click="closeConfigProjectTab(element.id)">Close</button>
                    </div>
                    <span class="projectText">{{element.alias}}</span>
                    <div class="boxInfoProjects" @click="handleClickProject(element.id)">
...
export default {
  ...
  data() {
    return {
        ...
        leaders: [],
        user: [],
        deleteProjectModalId: 99999,
        deleteProjectModalList: 99999,
    };
    },
    computed:{
    ...
    methods: {
        openModalDeleteProject: function(id, list){
            var proj = this.projects.filter(function(project) {
                    return  project.id == id;
            });
            this.deleteProjectModalTitle = proj[0].project_name;
            this.deleteProjectModal = true;
            this.deleteProjectModalId = id;
            this.deleteProjectModalList = list;
        },
        deleteProject: function(){
            var id = this.deleteProjectModalId;
            this.deleteProjectModal = false;
            var list = this.deleteProjectModalList;
            if(list == 1){
                this.list1 = this.list1.filter(function(project) {
                    return  project.id != id;
                });
            }else if(list == 2){
                this.list2 = this.list2.filter(function(project) {
                    return  project.id != id;
                });
            }else if(list == 3){
                this.list3 = this.list3.filter(function(project) {
                    return  project.id != id;
                });
            }else if(list == 4){
                this.list4 = this.list4.filter(function(project) {
                    return  project.id != id;
                });
            }else if(list == 5){
                this.list5 = this.list5.filter(function(project) {
                    return  project.id != id;
                });
            }
            axios.get('/Admin/Projects/Delete/'+id)
            .then(function (response) {
                console.log('Projecto ' + id + ' eliminado');
            })
            .catch(function (error) {
                console.log(error);
            });
            document.getElementById('box1TabContent'+id).style.display = 'none';
        },
        storeProject: function(id, list){
            if(list == 1){
                this.list1 = this.list1.filter(function(project) {
                    return  project.id != id;
                });
            ...
            axios.get('/Admin/Projects/Deactivate/'+id)
            .then(function (response) {
                console.log('Projecto ' + id + ' archivado');
            })
            .catch(function (error) {
                console.log(error);
            });
        ...
        openConfigProjectTab: function(id){
            document.getElementById('box1TabContent'+id).style.display = 'block';
        },
        closeConfigProjectTab: function(id){
            document.getElementById('box1TabContent'+id).style.display = 'none';
        },
    ...
    handleClickModaldeleteProject: function (){
        if(event.target.id == 'boxDeleteProjectModal'){
            this.deleteProjectModal = false;
        }
    },
    handleFileChange(e) {
